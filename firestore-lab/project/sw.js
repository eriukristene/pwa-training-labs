/**
 * 
 * Cloud Firestore also supports offline data persistence, which caches a local copy of your app's data that can be modified when users are offline, and synced once connectivity is restored. Combined with service workers, we can update our app to work offline.
 */
